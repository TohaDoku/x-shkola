            ...
            <div className="offer-container">
                ...
                <div className="offer-body">
                    <div className="offer-one">
                        ...
                        <div className="offer-card offer-card-mobile">
                            <span>02</span>
                            <div>
                        ...
                        <div className="offer-card">
                            ...
                            <div>
                                ...
                                <p>
                                    Учебные материалы, конспекты, шпаргалки, тесты, примеры заданий, а также инструкции
                        ...
                        <div className="offer-card offer-card-mobile">
                            ...
                            <div>
                                ...
                                <p>
                                    Преподаватели оказывают индивидуальную помощь в решении задач, объясняют непонятные
                                    темы, дают подсказки и методические рекомендации для эффективного выполнения
                                    заданий.
                                </p>
                            </div>
                        </div>
                        <div className="offer-card">
                            ...
                            <div>
                                ...
                                <p>
                                    Детальный отчет о текущих учебных достижениях, которые помогут определить
                                    прогресс <br/>
                    ...
                    <div className="offer-free offer-free-pk">
                        <div className="offer-card">
                            <span>02</span>
                            <div>
                            <h3>Полный разбор всех материалов для ЕГЭ</h3>
